...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <form method="post" action="{{asset('/ubah-pengalaman-proyek/'.$proyek_info->id)}}">
        {{ csrf_field() }}
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" value="{{$proyek_info->software}}" name="software" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="exampleInputEmail1" value="{{$proyek_info->tahun}}" name="tahun" required>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Kegiatan Matakuliah</label>
            <input type="text" class="form-control" id="exampleInputEmail1" value="{{$proyek_info->kegiatan_matakuliah}}" name="kegiatan_matakuliah" required>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Nilai Proyek</label>
            <input type="text" class="form-control" id="exampleInputEmail1" value="{{$proyek_info->nilai}}" name="nilai" required>
        </div>
