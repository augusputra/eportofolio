        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form method="POST" action="{{url('/tambah-dosen')}}" enctype="multipart/form-data" class="register-form" id="register-form">
                        {{ csrf_field() }}
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    <label for="last_name" class="required">NIDN</label>
                                    <input type="text" name="nidn" id="last_name" />
                                </div>
                                <div class="form-input">
                    ...
                    <center>
                        <a href="{{url('/logindosen')}}" class="signin">Sign In</a>
                    </center>
